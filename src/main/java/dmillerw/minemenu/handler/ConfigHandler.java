...
public class ConfigHandler {
    ...
    private static void loadConfig() {
        ...
        Property p_menuAlpha = config.get("visual.minemenu", "alpha", 153);
        Property p_menuRed = config.get("visual.minemenu", "red", 0);
        Property p_menuGreen = config.get("visual.minemenu", "green", 0);
        Property p_menuBlue = config.get("visual.minemenu", "blue", 0);
