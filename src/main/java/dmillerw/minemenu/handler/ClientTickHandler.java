package dmillerw.minemenu.handler;
...
import dmillerw.minemenu.gui.CompatibleScaledResolution;
import dmillerw.minemenu.gui.GuiRadialMenu;
import dmillerw.minemenu.helper.AngleHelper;
import dmillerw.minemenu.helper.ItemRenderHelper;
...
public class ClientTickHandler {
    ...
    private static void renderText(ScaledResolution resolution) {
        ...
        for (int i = 0; i < RadialMenu.MAX_ITEMS; i++) {
            ...
            if (mouseIn) {
                MenuItem item = RadialMenu.getActiveArray()[i];
                String string = item == null ? I18n.format("minemenu.gui.tip2")  : item.title;
