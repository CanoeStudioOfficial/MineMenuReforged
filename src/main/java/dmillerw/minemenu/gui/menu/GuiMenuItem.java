...
public class GuiMenuItem extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.buttonDelete = new GuiButton(2, this.width / 2 - 50, this.height - 60, 100, 20, I18n.format("minemenu.gui.tip5")));
        ...
        String string = I18n.format("minemenu.gui.tip3");
    ...
    public void drawScreen(int mouseX, int mouseY, float partial) {
        ...
        this.drawCenteredString(this.fontRenderer, I18n.format("minemenu.gui.tip1"), this.width / 2, 80, 16777215);
        super.drawScreen(mouseX, mouseY, partial);
        GuiRenderHelper.renderHeaderAndFooter(this, 25, 20, 5, I18n.format("minemenu.gui.tip4") + slot);
    }
}