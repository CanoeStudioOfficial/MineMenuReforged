...
public class GuiPickItem extends GuiScreen {
    ...
    public void drawScreen(int par1, int par2, float par3) {
        ...
        GuiRenderHelper.renderHeaderAndFooter(this, 25, 20, 5, I18n.format("minemenu.gui.tip16"));
    ...
    private void drawSlot(Slot slot, boolean scale) {
        ...
        if (!stack.isEmpty()) {
            if (scale) {
                ...
                ItemRenderHelper.renderItem((this.guiLeft + i + 8) / 2.0f, (this.guiTop + j + 8) / 2.0f, stack);
            } else {
